            ...
            <div className="nav-icon flex h-full ">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span
                    className={`nav-icon-wrapper my-auto ${
                      isOpen ? "selected" : ""
                    }`}
                  >
                ...
                {isOpen && (
                  <div className="absolute right-0 w-56 origin-top-right bg-white">
                    <div className="flex flex-col">
                      <div className="bg-[#f3f0fe] p-4 flex cursor-pointer">
                      ...
                      <div className="dropdown-body py-1">
                        <div>
                          <button className="block px-4 py-2 w-full text-start hover:bg-[#f3f0fe] group">
